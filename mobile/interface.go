...
func (i *Interface) SVBGash(hash *Hash)             { i.object = &hash.hash }
func (i *Interface) SVBGashes(hashes *Hashes)       { i.object = &hashes.hashes }
...
func (i *Interface) GVBGash() *Hash           { return &Hash{*i.object.(*common.Hash)} }
func (i *Interface) GVBGashes() *Hashes       { return &Hashes{*i.object.(*[]common.Hash)} }
