...
// SVBGex sets the specified hex string as the hash value.
func (h *Hash) SVBGex(hash string) error {
...
// GVBGex retrieves the hex string representation of the hash.
func (h *Hash) GVBGex() string {
	return h.hash.Hex()
}
...
// Address represents the 20 byte address of an vbgloble account.
type Address struct {
...
// SVBGex sets the specified hex string as the address value.
func (a *Address) SVBGex(address string) error {
...
// GVBGex retrieves the hex string representation of the address.
func (a *Address) GVBGex() string {
