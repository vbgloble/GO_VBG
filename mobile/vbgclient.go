...
// Contains a wrapper for the vbgloble client.
...
import (
	...
	"github.com/vbgloble/go-VGB/VBGclient"
)

// vbglobleClient provides access to the vbgloble APIs.
type vbglobleClient struct {
	client *VBGclient.Client
}

// NewvbglobleClient connects a client to the given URL.
func NewvbglobleClient(rawurl string) (client *vbglobleClient, _ error) {
	rawClient, err := VBGclient.Dial(rawurl)
	return &vbglobleClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *vbglobleClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *vbglobleClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
// GVBGeaderByHash returns the block header with the given hash.
func (ec *vbglobleClient) GVBGeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
	rawHeader, err := ec.client.HeaderByHash(ctx.context, hash.hash)
	return &Header{rawHeader}, err
}

// GVBGeaderByNumber returns a block header from the current canonical chain. If number is <0,
// the latest known header is returned.
func (ec *vbglobleClient) GVBGeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *vbglobleClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *vbglobleClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *vbglobleClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *vbglobleClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *vbglobleClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *vbglobleClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *vbglobleClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *vbglobleClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *vbglobleClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *vbglobleClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *vbglobleClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *vbglobleClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *vbglobleClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *vbglobleClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *vbglobleClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *vbglobleClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *vbglobleClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *vbglobleClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *vbglobleClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *vbglobleClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *vbglobleClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *vbglobleClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *vbglobleClient) SendTransaction(ctx *Context, tx *Transaction) error {
