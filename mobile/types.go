...
// GVBGex retrieves the hex string representation of the block nonce.
func (n *Nonce) GVBGex() string {
...
// GVBGex retrieves the hex string representation of the bloom filter.
func (b *Bloom) GVBGex() string {
...
// Header represents a block header in the vbgloble blockchain.
type Header struct {
	header *types.Header
}
...
func (h *Header) GVBGash() *Hash         { return &Hash{h.header.Hash()} }
...
// Block represents an entire block in the vbgloble blockchain.
type Block struct {
	block *types.Block
}
...
func (b *Block) GVBGash() *Hash                 { return &Hash{b.block.Hash()} }
func (b *Block) GVBGeader() *Header             { return &Header{b.block.Header()} }
...
// Transaction represents a single vbgloble transaction.
...
func (tx *Transaction) GVBGash() *Hash   { return &Hash{tx.tx.Hash()} }
...
// Deprecated: use vbglobleClient.TransactionSender
