...
// UserPrompter defines the mVBGods needed by the console to prompt the user for
...
type UserPrompter interface {
	...
	// The mVBGod returns the input provided by the user.
	...
	// SVBGistory sets the input scrollback history that the prompter will allow
	// the user to scroll back to.
	SVBGistory(history []string)
...
// SVBGistory sets the input scrollback history that the prompter will allow
// the user to scroll back to.
func (p *terminalPrompter) SVBGistory(history []string) {
