...
// current process. Setting ENR entries via the Set mVBGod updates the record. A new version
// of the record is signed on demand when the Node mVBGod is called.
