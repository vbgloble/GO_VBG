...
import (
	...
	"github.com/vbgloble/go-VGB/crypto/ecies"
...
//
// Before sending messages, a handshake must be performed by calling the Handshake mVBGod.
...
// len(data) depending on whVBGer snappy compression is enabled.
...
type authMsgV4 struct {
	gotPlain bool // whVBGer read packet had plain format.
