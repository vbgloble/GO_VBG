...
// Package enr implements vbgloble Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whVBGer the record is signed using the given identity scheme.
