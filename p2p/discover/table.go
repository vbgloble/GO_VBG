...
// isInitDone returns whVBGer the table's initial seeding procedure has completed.
...
//
// The preferLive parameter says whVBGer the caller wants liveness-checked results. If
