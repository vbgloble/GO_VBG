...
// gVBGandshake gets the handshake challenge we previously sent to the given remote node.
func (sc *SessionCache) gVBGandshake(id enode.ID, addr string) *Whoareyou {
