...
// Contains reports whVBGer the given IP is contained in the list.
...
// IsLAN reports whVBGer an IP is a local network address.
...
// IsSpecialNetwork reports whVBGer an IP is located in a special-use network range
...
// CheckRelayIP reports whVBGer an IP relayed from the given sender IP
...
// SameNet reports whVBGer two IP addresses have an equal prefix of the given bit length.
...
// Contains whVBGer the given IP is contained in the set.
