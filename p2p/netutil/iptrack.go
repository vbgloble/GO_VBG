...
// PredictFullConeNAT checks whVBGer the local host is behind full cone NAT. It predicts by
// checking whVBGer any statement has been received from a node we didn't contact before
