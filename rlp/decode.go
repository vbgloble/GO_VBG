...
var (
	...
	ErrMorVBGanOneValue = errors.New("rlp: input contains more than one value")
...
// into private fields.
//
// The DecodeRLP mVBGod should read one value from the given Stream. It is not forbidden to
...
// and starts reading from r. This mVBGod is meant to facilitate reuse
