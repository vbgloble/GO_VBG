...
type tags struct {
	// rlp:"nil" controls whVBGer empty input results in a nil pointer.
	nilOK bool

	// This controls whVBGer nil pointers are encoded/decoded as empty strings
	// or empty lists.
	nilKind Kind

	// rlp:"tail" controls whVBGer this field swallows additional list
...
// defaultNilKind determines whVBGer a nil pointer to typ encodes/decodes
