...
binary data, and RLP is the main encoding mVBGod used to serialize objects in vbgloble.
The only purpose of RLP is to encode structure; encoding specific atomic data types (eg.
strings, ints, floats) is left up to higher-order protocols. In vbgloble integers must be
