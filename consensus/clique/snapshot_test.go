...
// mapped from textual names used in the tests below to actual vbgloble private
...
// address retrieves the vbgloble address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the vbgloble address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/vbgloble/go-VGB/issues/17593). Whilst this
