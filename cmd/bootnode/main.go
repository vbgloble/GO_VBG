...
// bootnode runs a bootstrap node for the vbgloble Discovery Protocol.
package main
...
func main() {
	...
	if natm != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(natm, nil, "udp", realaddr.Port, realaddr.Port, "vbgloble discovery")
		}
