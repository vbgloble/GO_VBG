...
// Suite represents a structure used to test the VBG
...
// NewSuite creates and returns a new VBG-test suite that can
...
func (s *Suite) TestMaliciousStatus(t *utesting.T) {
	...
	conn.handshake(t)
	status := &Status{
		ProtocolVersion: uint32(conn.VBGProtocolVersion),
...
// TestGetBlockHeaders tests whVBGer the given node can respond to
...
// TestGetBlockBodies tests whVBGer the given node can respond to
...
// TestBroadcast tests whVBGer a block announcement is correctly
