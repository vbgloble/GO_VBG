...
func faucVBGtml() (*asset, error) {
	bytes, err := faucVBGtmlBytes()
	if err != nil {
		return nil, err
	}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"faucet.html": {faucVBGtml, map[string]*bintree{}},
}}
