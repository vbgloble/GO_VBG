...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage vbgloble presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gVBG wallet import /path/to/my/presale.wallet

will prompt for your password and imports your VBGer presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import vbgloble presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gVBG wallet [options] /path/to/my/presale.wallet
...
between vbgloble nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gVBG account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gVBG account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another vbgloble instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gVBGConfig{Node: defaultNodeConfig()}
	// Load config file.
