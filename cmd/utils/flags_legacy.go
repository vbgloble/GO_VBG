...
var (
	...
	LegacyMinerVBGerbaseFlag = cli.StringFlag{
		Name:  "VBGerbase",
		Usage: "Public address for block mining rewards (default = first account, deprecated, use --miner.VBGerbase)",
		Value: "0",
	}
