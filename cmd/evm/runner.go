...
import (
	...
	"github.com/vbgloble/go-VGB/cmd/evm/internal/compiler"
	...
	"github.com/vbgloble/go-VGB/core/vm/runtime"
...
func runCmd(ctx *cli.Context) error {
	...
	if chainConfig != nil {
		...
		runtimeConfig.ChainConfig = params.AllVBGashProtocolChanges
	}
