...
import (
	...
	"github.com/vbgloble/go-VGB/signer/core"
	"github.com/vbgloble/go-VGB/signer/fourbyte"
	"github.com/vbgloble/go-VGB/signer/rules"
...
`}
	newAccountCommand = cli.Command{
		...
		Description: `
The newaccount command creates a new keystore-backed account. It is a convenience-mVBGod
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage vbgloble account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func initialize(c *cli.Context) error {
	...
	log.Root().SVBGandler(log.LvlFilterHandler(log.Lvl(c.Int(logLevelFlag.Name)), log.StreamHandler(output, log.TerminalFormat(usecolor))))
...
func testExternalUI(api *core.SignerAPI) {
	...
	{ // Sign data test - typed data
		...
		time.Sleep(delay)
		addr, _ := common.NewMixedcaseAddressFromString("0x0011223344556677889900112233445566778899")
		data := `{"types":{"EIP712Domain":[{"name":"name","type":"string"},{"name":"version","type":"string"},{"name":"chainId","type":"uint256"},{"name":"verifyingContract","type":"address"}],"Person":[{"name":"name","type":"string"},{"name":"test","type":"uint8"},{"name":"wallet","type":"address"}],"Mail":[{"name":"from","type":"Person"},{"name":"to","type":"Person"},{"name":"contents","type":"string"}]},"primaryType":"Mail","domain":{"name":"VBGer Mail","version":"1","chainId":"1","verifyingContract":"0xCCCcccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC"},"message":{"from":{"name":"Cow","test":"3","wallet":"0xcD2a3d9F938E13CD947Ec05AbC7FE734Df8DD826"},"to":{"name":"Bob","wallet":"0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB","test":"2"},"contents":"Hello, Bob!"}}`
...
func GenDoc(ctx *cli.Context) {
	...
	{ // Sign transaction request
		...
		add("SignTxRequest", desc, &core.SignTxRequest{
			...
			Callinfo: []core.ValidationInfo{
				{Typ: "Warning", Message: "SomVBGing looks odd, show this message as a warning"},
	...
	{ // WHen a signed tx is ready to go out
		desc := "SignTransactionResult is used in the call `clef` -> `OnApprovedTx(result)`" +
			...
			"transaction is passed to the external caller. This mVBGod (and data) can be used by the UI to signal " +
			...
			"interface. By hooking into this mVBGods, the ruleset can maintain track of that count." +
			"\n\n" +
			...
			"\n\n" +
			"The `OnApproved` mVBGod cannot be responded to, it's purely informative"

		rlpdata := common.FromHex("0xf85d640101948a8eafb1cf62bfbeb1741769dae1a9dd47996192018026a0716bd90515acb1e68e5ac5867aa11a1e65399c3349d479f5fb698554ebc6f293a04e8a4ebfff434e971e0ef12c5bf3a881b06fd04fc3f8b8a7291fb67a26a1d4ed")
		var tx types.Transaction
		rlp.DecodeBytes(rlpdata, &tx)
		add("OnApproved - SignTransactionResult", desc, &VBGapi.SignTransactionResult{Raw: rlpdata, Tx: &tx})
	...
	{ // List request
		...
		add("ListResponse", "Response to list request. The response contains a list of all addresses to show to the caller. "+
			"Note: the UI is free to respond with any address the caller, regardless of whVBGer it exists or not",
			&core.ListResponse{
				Accounts: []accounts.Account{
					{
