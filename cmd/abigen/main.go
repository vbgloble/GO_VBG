...
import (
	...
	"github.com/vbgloble/go-VGB/common/compiler"
...
var (
	...
	abiFlag = cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the vbgloble contract ABI json to bind, - for STDIN",
	}
	binFlag = cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the vbgloble contract bytecode (generate deploy mVBGod)",
	}
	...
	solFlag = cli.StringFlag{
		Name:  "sol",
		Usage: "Path to the vbgloble contract Solidity source to build and bind",
	}
	...
	vyFlag = cli.StringFlag{
		Name:  "vy",
		Usage: "Path to the vbgloble contract Vyper source to build and bind",
	}
