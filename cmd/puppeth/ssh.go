...
// sshClient is a small wrapper around Go's SSH client with a few utility mVBGods
// implemented on top.
...
func dial(server string, pubkey []byte) (*sshClient, error) {
	...
	// Configure the supported authentication mVBGods (private key and password)
	var auths []ssh.AuthMVBGod
...
// capable of acting as puppVBG target.
