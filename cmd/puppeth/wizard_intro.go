...
// makeWizard creates and returns a new puppVBG wizard.
...
// setting up a new or managing an existing vbgloble private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppVBG, your vbgloble private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new vbgloble network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and VBGstats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| PuppVBG uses SSH to dial in to remote servers, and builds |")
	...
	log.Info("Administering vbgloble network", "name", w.network)

	// Load initial configurations and connect to all live servers
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".puppVBG", w.network)
