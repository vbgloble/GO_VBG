...
// TestMinerSetVBGerbase checks that VBGerbase becomes set even if mining isn't
// possible at the moment
func TestMinerSetVBGerbase(t *testing.T) {
	miner, mux := createMiner(t)
...
func createMiner(t *testing.T) (*Miner, *event.TypeMux) {
	// Create VBGash config
	config := Config{
		VBGerbase: common.HexToAddress("123456789"),
	}
	// Create chainConfig
	memdb := memorydb.New()
