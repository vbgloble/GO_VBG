...
func main() {
	...
	for _, sealer := range sealers {
		...
		stack, VBGBackend, err := makeSealer(genesis)
		if err != nil {
			panic(err)
		}
		defer stack.Close()
...
func makeSealer(genesis *core.Genesis) (*node.Node, *VBG.vbgloble, error) {
	...
	// Start the node and configure a full vbgloble node on it
