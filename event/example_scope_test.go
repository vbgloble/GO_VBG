...
// The app's SubscribeResults mVBGod starts sending calculation results to the given
// channel. Subscriptions created through this mVBGod are tied to the lifetime of the App
