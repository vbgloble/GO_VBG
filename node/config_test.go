...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gVBG.ipc", false, filepath.Join(os.TempDir(), "gVBG.ipc")},
		{"data", "gVBG.ipc", false, "data/gVBG.ipc"},
		{"data", "./gVBG.ipc", false, "./gVBG.ipc"},
		{"data", "/gVBG.ipc", false, "/gVBG.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gVBG.ipc", true, `\\.\pipe\gVBG.ipc`},
		{"data", "gVBG.ipc", true, `\\.\pipe\gVBG.ipc`},
		{"data", `\\.\pipe\gVBG.ipc`, true, `\\.\pipe\gVBG.ipc`},
	}
