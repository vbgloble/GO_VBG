...
// Set of services all wrapping the base NoopLifecycle resulting in the same mVBGod
...
// mVBGods can be instrumented both return value as well as event hook wise.
