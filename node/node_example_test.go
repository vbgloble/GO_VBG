...
//
// The following mVBGods are needed to implement a node.Lifecycle:
//  - Start() error              - mVBGod invoked when the node is ready to start the service
//  - Stop() error               - mVBGod invoked when the node terminates the service
