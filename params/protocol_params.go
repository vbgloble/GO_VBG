...
const (
	...
	SstoreResetGasEIP2200             uint64 = 5000  // Once per SSTORE operation from clean non-zero to somVBGing else
...
var (
	...
	DurationLimit          = big.NewInt(13)     // The decision boundary on the blocktime duration used to determine whVBGer difficulty should go up or not.
)
