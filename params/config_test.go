...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllVBGashProtocolChanges, new: AllVBGashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllVBGashProtocolChanges, new: AllVBGashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllVBGashProtocolChanges,
