...
var (
	...
	// AllVBGashProtocolChanges contains every protocol change (EIPs) introduced
	// and accepted by the vbgloble core developers into the VBGash consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllVBGashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, new(VBGashConfig), nil}

	// AllCliqueProtocolChanges contains every protocol change (EIPs) introduced
	// and accepted by the vbgloble core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	...
	TestChainConfig = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, new(VBGashConfig), nil}
...
// Empty returns an indicator whVBGer the checkpoint is regarded as empty.
...
type ChainConfig struct {
	...
	DAOForkSupport bool     `json:"daoForkSupport,omitempty"` // WhVBGer the nodes supports or opposes the DAO hard-fork

	// EIP150 implements the Gas price changes (https://github.com/vbgloble/EIPs/issues/150)
	...
	VBGash *VBGashConfig `json:"VBGash,omitempty"`
	Clique *CliqueConfig `json:"clique,omitempty"`
}

// VBGashConfig is the consensus engine configs for proof-of-work based sealing.
type VBGashConfig struct{}

// String implements the stringer interface, returning the consensus engine details.
func (c *VBGashConfig) String() string {
	return "VBGash"
}
...
// IsHomestead returns whVBGer num is either equal to the homestead block or greater.
func (c *ChainConfig) IsHomestead(num *big.Int) bool {
	return isForked(c.HomesteadBlock, num)
}

// IsDAOFork returns whVBGer num is either equal to the DAO fork block or greater.
func (c *ChainConfig) IsDAOFork(num *big.Int) bool {
	return isForked(c.DAOForkBlock, num)
}

// IsEIP150 returns whVBGer num is either equal to the EIP150 fork block or greater.
func (c *ChainConfig) IsEIP150(num *big.Int) bool {
	return isForked(c.EIP150Block, num)
}

// IsEIP155 returns whVBGer num is either equal to the EIP155 fork block or greater.
func (c *ChainConfig) IsEIP155(num *big.Int) bool {
	return isForked(c.EIP155Block, num)
}

// IsEIP158 returns whVBGer num is either equal to the EIP158 fork block or greater.
func (c *ChainConfig) IsEIP158(num *big.Int) bool {
	return isForked(c.EIP158Block, num)
}

// IsByzantium returns whVBGer num is either equal to the Byzantium fork block or greater.
func (c *ChainConfig) IsByzantium(num *big.Int) bool {
	return isForked(c.ByzantiumBlock, num)
}

// IsConstantinople returns whVBGer num is either equal to the Constantinople fork block or greater.
func (c *ChainConfig) IsConstantinople(num *big.Int) bool {
	return isForked(c.ConstantinopleBlock, num)
}

// IsMuirGlacier returns whVBGer num is either equal to the Muir Glacier (EIP-2384) fork block or greater.
func (c *ChainConfig) IsMuirGlacier(num *big.Int) bool {
	return isForked(c.MuirGlacierBlock, num)
}

// IsPetersburg returns whVBGer num is either
...
// IsIstanbul returns whVBGer num is either equal to the Istanbul fork block or greater.
func (c *ChainConfig) IsIstanbul(num *big.Int) bool {
	return isForked(c.IstanbulBlock, num)
}

// IsYoloV2 returns whVBGer num is either equal to the YoloV1 fork block or greater.
func (c *ChainConfig) IsYoloV2(num *big.Int) bool {
	return isForked(c.YoloV2Block, num)
}

// IsEWASM returns whVBGer num represents a block number after the EWASM fork
func (c *ChainConfig) IsEWASM(num *big.Int) bool {
	return isForked(c.EWASMBlock, num)
}

// CheckCompatible checks whVBGer scheduled fork transitions have been imported
...
// CheckConfigForkOrder checks that we don't "skip" any forks, gVBG isn't pluggable enough
...
// isForked returns whVBGer a fork scheduled at block s is active at the given head block.
