...
type LesOdrRequest interface {
	...
	Validate(VBGdb.Database, *Msg) error
}
...
func (r *BlockRequest) Validate(db VBGdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ReceiptsRequest) Validate(db VBGdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *TrieRequest) Validate(db VBGdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *CodeRequest) Validate(db VBGdb.Database, msg *Msg) error {
...
func (r *ChtRequest) GetCost(peer *serverPeer) uint64 {
	return peer.getRequestCost(GVBGelperTrieProofsMsg, 1)
}
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ChtRequest) Validate(db VBGdb.Database, msg *Msg) error {
...
func (r *BloomRequest) GetCost(peer *serverPeer) uint64 {
	return peer.getRequestCost(GVBGelperTrieProofsMsg, len(r.SectionIndexList))
}
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *BloomRequest) Validate(db VBGdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *TxStatusRequest) Validate(db VBGdb.Database, msg *Msg) error {
