...
// checkCallbacks checks whVBGer the threshold of any of the active callbacks
...
// checkPriorityStatus checks whVBGer the node has gained priority status and sets the priority
