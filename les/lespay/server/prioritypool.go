...
// RequestCapacity checks whVBGer changing the capacity of a node to the given target
...
// the minimum priority needed to do the change and whVBGer it is currently allowed.
