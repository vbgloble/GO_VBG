...
func TestULCAnnouncVBGresholdLes2(t *testing.T) { testULCAnnouncVBGreshold(t, 2) }
func TestULCAnnouncVBGresholdLes3(t *testing.T) { testULCAnnouncVBGreshold(t, 3) }

func testULCAnnouncVBGreshold(t *testing.T, protocol int) {
