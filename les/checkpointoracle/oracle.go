...
type CheckpointOracle struct {
	...
	running  int32                                 // Flag whVBGer the contract backend is set or not
...
// IsRunning returns an indicator whVBGer the oracle is running.
...
// checks whVBGer there are enough approvals to finalize the checkpoint.
