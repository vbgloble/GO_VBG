...
var (
	...
	reqAvgTimeCost = requestCostTable{
		...
		GVBGelperTrieProofsMsg: {0, 1000000},
...
func newCostTracker(db VBGdb.Database, config *VBG.Config) (*costTracker, uint64) {
...
func (ct *costTracker) gfLoop() {
	...
	threshold := gfUsagVBGreshold * float64(gfUsageTC) * ct.utilTarget / flowcontrol.FixedPointMultiplier
