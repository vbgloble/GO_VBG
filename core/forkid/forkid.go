...
// Package forkid implements EIP-2124 (https://eips.vbgloble.org/EIPS/eip-2124).
package forkid
...
// Blockchain defines all necessary mVBGod to build a forkID.
...
// NewID calculates the vbgloble fork ID from the chain config, genesis hash, and head.
...
func newFilter(config *params.ChainConfig, genesis common.Hash, headfn func() uint64) Filter {
	...
	return func(id ID) error {
		...
		return nil // SomVBGing's very wrong, accept rather than reject
	}
}
