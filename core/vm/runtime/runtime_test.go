...
import (
	...
	"github.com/vbgloble/go-VGB/core/asm"
...
func (d *dummyChain) GVBGeader(h common.Hash, n uint64) *types.Header {
	d.counter++
	...
	//fmt.Printf("GVBGeader(%x, %d) => header with parent %x\n", h, n, parentHash)
...
func TestBlockhash(t *testing.T) {
	...
	*/
	...
	// The mVBGod call to 'test()'
	input := common.Hex2Bytes("f8a8fd6d")
	chain := &dummyChain{}
	ret, _, err := Execute(data, input, &Config{
		GVBGashFn:   core.GVBGashFn(header, chain),
