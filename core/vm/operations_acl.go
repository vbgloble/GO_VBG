...
// gasEip2929AccountCheck checks whVBGer the first stack item (as address) is present in the access list.
// If it is, this mVBGod returns '0', otherwise 'cold-warm' gas, presuming that the opcode using it
// is also using 'warm' as constant factor.
// This mVBGod is used by:
// - extcodehash,
// - extcodesize,
// - (ext) balance
