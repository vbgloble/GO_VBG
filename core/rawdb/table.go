...
func NewTable(db VBGdb.Database, prefix string) VBGdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) VBGdb.Iterator {
...
func (t *table) NewBatch() VBGdb.Batch {
...
func (b *tableBatch) Replay(w VBGdb.KeyValueWriter) error {
