...
//   reserving it for go-VGB. This would also reduce the memory requirements
//   of GVBG, and thus also GC overhead.
type freezer struct {
...
// HasAncient returns an indicator whVBGer the specified ancient data exists
// in the freezer.
...
func (f *freezer) freeze(db VBGdb.KeyValueStore) {
	...
	for {
		...
		// Log somVBGing friendly for the user
		context := []interface{}{
