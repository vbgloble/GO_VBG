...
func ReadDatabaseVersion(db VBGdb.KeyValueReader) *uint64 {
	var version uint64
...
func WriteDatabaseVersion(db VBGdb.KeyValueWriter, version uint64) {
...
func ReadChainConfig(db VBGdb.KeyValueReader, hash common.Hash) *params.ChainConfig {
...
func WriteChainConfig(db VBGdb.KeyValueWriter, hash common.Hash, cfg *params.ChainConfig) {
	if cfg == nil {
		return
	}
