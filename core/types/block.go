...
// Package types contains data types related to vbgloble consensus.
package types
...
// a block's data contents (transactions and uncles) togVBGer.
type Body struct {
...
type Block struct {
	...
	// These fields are used by package VBG to track
...
// [deprecated by VBG/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for VBG protocol, etc.
...
// DecodeRLP decodes the vbgloble
...
// EncodeRLP serializes b into the vbgloble RLP block format.
