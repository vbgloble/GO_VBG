...
// newDiffLayer creates a new diff on top of an existing snapshot, whVBGer that's a low
...
// Stale return whVBGer this layer has become stale (was flattened across) or if
// it's still live.
...
func (dl *diffLayer) AccountRLP(hash common.Hash) ([]byte, error) {
	// Check the bloom filter first whVBGer there's even a point in reaching into
...
func (dl *diffLayer) flatten() snapshot {
	...
	// be smarter about grouping flattens togVBGer).
