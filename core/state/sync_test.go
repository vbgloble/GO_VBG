...
// account array.
func checkStateAccounts(t *testing.T, db VBGdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db VBGdb.Database, root common.Hash) error {
...
func checkStateConsistency(db VBGdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	// isCode reports whVBGer the hash is contract code hash.
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(VBGdb.Database), srcRoot)
