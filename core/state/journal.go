...
type journalEntry interface {
	...
	// dirtied returns the vbgloble address modified by this journal entry.
...
// otherwise suggest it as clean. This mVBGod is an ugly hack to handle the RIPEMD
...
type (
	...
	suicideChange struct {
		account     *common.Address
		prev        bool // whVBGer account had already suicided
		prevbalance *big.Int
	}
