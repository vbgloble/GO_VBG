...
// It offers only mVBGods that operates on data that can be available to anyone without security risks.
...
// Syncing provides information when this nodes starts synchronising with the vbgloble network and when it's finished.
...
type SyncingResult struct {
	...
	Status  vbgloble.SyncProgress `json:"status"`
}
