...
func makeChain(n int, seed byte, parent *types.Block, empty bool) ([]*types.Block, []types.Receipts) {
	blocks, receipts := core.GenerateChain(params.TestChainConfig, parent, VBGash.NewFaker(), testdb, n, func(i int, block *core.BlockGen) {
...
func XTestDelivery(t *testing.T) {
	...
	world.progress(10)
	if false {
		log.Root().SVBGandler(log.StdoutHandler)
