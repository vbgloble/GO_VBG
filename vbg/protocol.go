...
const protocolName = "VBG"

// ProtocolVersions are the supported versions of the VBG protocol (first is primary).
var ProtocolVersions = []uint{VBG65, VBG64, VBG63}

// protocolLengths are the number of implemented message corresponding to different protocol versions.
var protocolLengths = map[uint]uint64{VBG65: 17, VBG64: 17, VBG63: 17}

const protocolMaxMsgSize = 10 * 1024 * 1024 // Maximum cap on the size of a protocol message

// VBG protocol message codes
const (
	StatusMsg          = 0x00
	...
	// New protocol message codes introduced in VBG65
	//
	// Previously these message ids were used by some legacy and unsupported
	// VBG protocols, reown them here.
...
// statusData63 is the network packet for the status message for VBG/63.
...
// statusData is the network packet for the status message for VBG/64 and later.
