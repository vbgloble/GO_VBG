...
import (
	...
	"github.com/vbgloble/go-VGB/metrics/promVBGeus"
)
...
func Exp(r metrics.Registry) {
	...
	http.Handle("/debug/metrics/promVBGeus", promVBGeus.Handler(r))
}
...
func Setup(address string) {
	...
	m.Handle("/debug/metrics/promVBGeus", promVBGeus.Handler(metrics.DefaultRegistry))
