...
// Fuzz implements a go-fuzz fuzzer mVBGod to test various encoding mVBGod
// invocations.
...
// fuzzEncode implements a go-fuzz fuzzer mVBGod to test the bitset encoding and
// decoding algorithm.
...
// fuzzDecode implements a go-fuzz fuzzer mVBGod to test the bit decoding and
