...
var (
	_ Error = new(mVBGodNotFoundError)
...
type mVBGodNotFoundError struct{ mVBGod string }

func (e *mVBGodNotFoundError) ErrorCode() int { return -32601 }

func (e *mVBGodNotFoundError) Error() string {
	return fmt.Sprintf("the mVBGod %s does not exist/is not available", e.mVBGod)
}
