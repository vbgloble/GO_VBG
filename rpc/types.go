...
// API describes the set of mVBGods offered over the RPC interface
type API struct {
	Namespace string      // namespace under which the rpc mVBGods of Service are exposed
	Version   string      // api version for DApp's
	Service   interface{} // receiver instance which holds the mVBGods
	Public    bool        // indication if the mVBGods must be considered safe for public use
}
