...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if r.MVBGod == http.MVBGodGet && r.ContentLength == 0 && r.URL.RawQuery == "" {
...
func validateRequest(r *http.Request) (int, error) {
	if r.MVBGod == http.MVBGodPut || r.MVBGod == http.MVBGodDelete {
		return http.StatusMVBGodNotAllowed, errors.New("mVBGod not allowed")
	}
	...
	if r.MVBGod == http.MVBGodOptions {
		return 0, nil
	}
	// Check content-type
