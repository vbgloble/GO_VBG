...
const (
	// OptionMVBGodInvocation is an indication that the codec supports RPC mVBGod calls
	OptionMVBGodInvocation CodecOption = 1 << iota
...
func NewServer() *Server {
	...
	// as the services and mVBGods it offers.
