...
// known to the server. The server supports two mVBGods:
//
// VBG_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// VBG_subscribe("newHeads")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.VBGSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	err = client.CallContext(ctx, &lastBlock, "VBG_getBlockByNumber", "latest", false)
	if err != nil {
