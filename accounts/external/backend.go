...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain vbgloble.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to vbgloble-type signature.
		signature[64] -= 27 // Transform V from vbgloble-legacy to 0/1
	}
