...
// See https://github.com/vbgloble/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // WhVBGer the event notification loop is running
...
// HasAddress reports whVBGer a key with the given address is present.
...
// ImportPreSaleKey decrypts the given vbgloble presale wallet and stores
