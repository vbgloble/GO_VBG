...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/vbgloble/pyVBGsaletool

		pyVBGsaletool generates the encryption key from password by
	...
	*/
	...
	VBGPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(VBGPriv)
	...
	expectedAddr := preSaleKeyStruct.VBGAddr
