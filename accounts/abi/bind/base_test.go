...
func (mc *mockCaller) CallContract(ctx context.Context, call vbgloble.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call vbgloble.CallMsg) ([]byte, error) {
...
func TestPassingBlockNumber(t *testing.T) {
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber}, nil, "somVBGing")
	...
	bc.Call(&bind.CallOpts{}, nil, "somVBGing")
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber, Pending: true}, nil, "somVBGing")
