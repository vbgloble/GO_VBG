...
func New(stack *node.Node, backend VBGapi.Backend, cors, vhosts []string) error {
	if backend == nil {
...
func newHandler(stack *node.Node, backend VBGapi.Backend, cors, vhosts []string) error {
	q := Resolver{backend}
