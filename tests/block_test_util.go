...
// Package tests implements execution of vbgloble JSON tests.
package tests
...
/* See https://github.com/vbgloble/tests/wiki/Blockchain-Tests-II

   WhVBGer a block is valid or not is a bit subtle, it's defined by presence of
