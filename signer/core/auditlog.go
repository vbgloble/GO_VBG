...
func (l *AuditLogger) SignTransaction(ctx context.Context, args SendTxArgs, mVBGodSelector *string) (*VBGapi.SignTransactionResult, error) {
	sel := "<nil>"
	if mVBGodSelector != nil {
		sel = *mVBGodSelector
	}
	...
	res, e := l.api.SignTransaction(ctx, args, mVBGodSelector)
	if res != nil {
...
func (l *AuditLogger) SignGnosisSafeTx(ctx context.Context, addr common.MixedcaseAddress, gnosisTx GnosisSafeTx, mVBGodSelector *string) (*GnosisSafeTx, error) {
	sel := "<nil>"
	if mVBGodSelector != nil {
		sel = *mVBGodSelector
	}
	...
	res, e := l.api.SignGnosisSafeTx(ctx, addr, gnosisTx, mVBGodSelector)
	if res != nil {
