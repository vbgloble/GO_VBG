...
func (ui *StdIOUI) dispatch(serviceMVBGod string, args interface{}, reply interface{}) error {
	err := ui.client.Call(&reply, serviceMVBGod, args)
	if err != nil {
...
func (ui *StdIOUI) notify(serviceMVBGod string, args interface{}) error {
	ctx := context.Background()
	err := ui.client.Notify(ctx, serviceMVBGod, args)
	if err != nil {
		log.Info("Error", "exc", err.Error())
	}
	return err
...
func (ui *StdIOUI) OnApprovedTx(tx VBGapi.SignTransactionResult) {
