...
// valid JSON. The constructor does no other validation of contents. This mVBGod
...
// Selector checks the given 4byte ID against the known ABI mVBGods.
//
// This mVBGod does not validate the match, it's assumed the caller will do.
...
//
// Node, this mVBGod does _not_ validate the correctness of the data. It assumes
